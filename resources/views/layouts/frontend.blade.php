...
<meta property="twitter:image" content="https://uideck.com/wp-content/uploads/2021/09/play-meta-bs.jpg">
  ...
  <body>
      ...
      <div class="container">
        <div class="ud-about-wrapper wow fadeInUp" data-wow-delay=".2s">
          ...
          <div class="ud-about-image">
            <img src="{{ asset('play-bootstrap-main') }}/assets/images/about/about-image.svg" alt="about-image" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="faq" class="ud-faq">
      <div class="shape">
        <img src="{{ asset('play-bootstrap-main') }}/assets/images/faq/shape.svg" alt="shape" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/testimonials/author-01.png"
                    alt="author"
                  />
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/testimonials/author-02.png"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            >
              ...
              <div class="ud-testimonial-info">
                <div class="ud-testimonial-image">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/testimonials/author-03.png"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
            ...
            <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="ud-brands-logo">
                <div class="ud-single-logo">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/brands/ayroui.svg" alt="ayroui" />
                </div>
                <div class="ud-single-logo">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/brands/uideck.svg" alt="uideck" />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/brands/graygrids.svg"
                    alt="graygrids"
                  />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/brands/lineicons.svg"
                    alt="lineicons"
                  />
                </div>
                <div class="ud-single-logo">
                  <img
                    src="{{ asset('play-bootstrap-main') }}/assets/images/brands/ecommerce-html.svg"
                    alt="ecommerce-html"
                  />
                </div>
              </div>
        ...
        <div class="row">
            ...
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/team/team-01.png" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".15s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/team/team-02.png" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".2s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/team/team-03.png" alt="team" />
                </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            <div class="ud-single-team wow fadeInUp" data-wow-delay=".25s">
              <div class="ud-team-image-wrapper">
                <div class="ud-team-image">
                  <img src="{{ asset('play-bootstrap-main') }}/assets/images/team/team-04.png" alt="team" />
                </div>
    ...
    <footer class="ud-footer wow fadeInUp" data-wow-delay=".15s">
      <div class="shape shape-1">
        <img src="{{ asset('play-bootstrap-main') }}/assets/images/footer/shape-1.svg" alt="shape" />
      </div>
      <div class="shape shape-2">
        <img src="{{ asset('play-bootstrap-main') }}/assets/images/footer/shape-2.svg" alt="shape" />
      </div>
      <div class="shape shape-3">
        <img src="{{ asset('play-bootstrap-main') }}/assets/images/footer/shape-3.svg" alt="shape" />
      </div>
              ...
              <div class="ud-widget">
                ...
                <ul class="ud-widget-brands">
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/ayroui.svg"
                        alt="ayroui"
                      />
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/ecommerce-html.svg"
                        alt="ecommerce-html"
                      />
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/graygrids.svg"
                        alt="graygrids"
                      />
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/lineicons.svg"
                        alt="lineicons"
                      />
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/uideck.svg"
                        alt="uideck"
                      />
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      <img
                        src="{{ asset('play-bootstrap-main') }}/assets/images/footer/brands/tailwindtemplates.svg"
